 ...
 * to the LPU's scholarship policy 2016, and stores the information in the file.     
 *
 ***************************************************************************/
...
class scholar
{
	...
	public:
		...
		void out()
		{
			...
			fstream f10; //SCHOLARSHIP DATA IN FILE//
...
int main()
{
	...
	if(x==1||x==2)
	{
		if(x==1)  //FEE STRUCTURE DETAILS IN FILE//
		{ 
		    fstream f1; 
			...
			cout<<endl<<endl<<"Your Fee Structure For B.Tech (CSE) is:-"; //DETAILS ON COMPILER SCREEN//
